...
function SendDistressSignal()
  ...
  exports['mythic_notify']:SendAlert('succes', 'Pesan Baru')

    TriggerServerEvent('esx_addons_gcphone:startCall', 'pedagang', "Pesan Baru", PlayerCoords, {
...
function OpenCloakroomMenu()
  ...
  local elements = {
    { label = "baju biasa",     value = 'citizen_wear'},
...
function OpenVaultMenu()
    ...
    local elements = {
      {label = "Kunyit - Rp.100", value = 'kunyit'}
    }
    ...
    ESX.UI.Menu.Open(
	  ...
	  local valor = 0
		...
		if data.current.value == "kunyit" then
			valor = 1
    end
    
		TriggerServerEvent('esx_pedagang:shop', data.current.value, valor)
		TriggerServerEvent('esx_society:depositMoney', "pedagang", valor)
      end,
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "~g~E~w~ untuk membeli bahan"
        CurrentActionData = {}
      end
    )
...
function OpenFridgeMenu()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "~g~E~w~ Untuk membuka lemari es"
        CurrentActionData = {}
      end
    )
...
function OpenCozinharMenu()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_pedagang:craftingCoktails', data.current.value)
      ...
      function(data, menu)
        ...
        CurrentActionMsg  = "~g~E~w~ Untuk Memasak"
        CurrentActionData = {}
      end
    )
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
			...
			TriggerServerEvent('esx_pedagang:Billing', amount, player)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_pedagang:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pedagang:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_pedagang:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pedagang:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_pedagang:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pedagang:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pedagang:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_pedagang:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_pedagang:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_pedagang:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    for i=1, #Config.Zones[zone].Items, 1 do
        ...
        table.insert(elements, {
            label     = item.label .. ' - <span style="color:red;">Rp' .. item.price .. ' </span>',
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('esx_pedagang:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_pedagang:hasEnteredMarker', function(zone)
	...
	if zone == 'Cook' then
      CurrentAction     = 'menu_cook'
      CurrentActionMsg  = "Tekan ~INPUT_CONTEXT~ Untuk Memasak."
      CurrentActionData = {}
    end
...
AddEventHandler('esx_pedagang:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_pedagang:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_pedagang:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(0,  Keys['F7']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'pedagang_actions') then
...
AddEventHandler('esx_pedagang:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_pedagang:teleportMarkers', position)
        end
